    ...
    ui(new Ui::EnterPassword)
{
    ...
    this->setStyleSheet("background-color: qlineargradient"
                      "(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(240,248,255, 255), stop:1 rgba(240,248,255, 255));"); this->setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(240,248,255, 255), stop:1 rgba(240,248,255, 255));");
    this->show();
}
